    ...
    <>
      <div className="albumContent">
        <div className="topBan">
          {/*this is used to show the album cover when clicked */}
          <img 
            src={albumDetails.image}
            alt="albumcover" 
            className="albumCover"
          ></img>
          {/* this is used to show the album details when clicked*/}
        ...
        <div className="tableHeader">
          <div className="numberHeader">No.</div>
          <div className="titleHeader">TITLE</div>
          <div className="numberHeader">
            <ClockCircleOutlined />
          </div>
        </div>
        {/*here we parse the song meta data and store it in the nft variable */}
        {album &&
          album.map((nft, i) => {
